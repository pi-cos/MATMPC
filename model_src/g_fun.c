...
/* g_fun:(states[4],controls,params[1415],xdot[4],alg[0])->(zfun) */
...
void mex_g_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+1425);
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+4, casadi_s1, w+1425);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+5, casadi_s2, w+1425);
  if (--argc>=0) arg[3] = casadi_from_mex(argv[3], w+1420, casadi_s0, w+1425);
  if (--argc>=0) arg[4] = casadi_from_mex(argv[4], w+1424, casadi_s3, w+1425);
  casadi_real* res[1] = {0};
  --resc;
  res[0] = w+1424;
  i = g_fun(arg, res, iw, w+1425, 0);
