...
/* gp_jac_fun:(i0[4],i1,i2[1415],i3[0])->(o0[4x4],o1[4]) */
...
void mex_gp_jac_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+4, casadi_s1, w+1440);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+5, casadi_s2, w+1440);
  if (--argc>=0) arg[3] = casadi_from_mex(argv[3], w+1420, casadi_s3, w+1440);
  casadi_real* res[2] = {0};
  --resc;
  res[0] = w+1420;
  if (--resc>=0) res[1] = w+1436;
  i = gp_jac_fun(arg, res, iw, w+1440, 0);
