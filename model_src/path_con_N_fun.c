...
/* path_con_N_fun:(states[4],params[1415])->(general_con_N[]) */
...
void mex_path_con_N_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+1419);
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+4, casadi_s1, w+1419);
  casadi_real* res[1] = {0};
  --resc;
  res[0] = w+1419;
  i = path_con_N_fun(arg, res, iw, w+1419, 0);
