...
#else
  #define CASADI_PREFIX(ID) gp_fun_ ## ID
#endif
...
/* gp_fun:(i0[4],i1,i2[1415],i3[0])->(o0[4]) */
...
#ifdef MATLAB_MEX_FILE
void mex_gp_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  int i, j;
  if (argc>4) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"gp_fun\" failed. Too many input arguments (%d, max 4)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"gp_fun\" failed. Too many output arguments (%d, max 1)", resc);
  int *iw = 0;
  casadi_real w[2839];
  ...
  --resc;
  res[0] = w+1420;
  i = gp_fun(arg, res, iw, w+1424, 0);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"gp_fun\" failed.");
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    /* name error */
  } else if (strcmp(buf, "gp_fun")==0) {
    return mex_gp_fun(resc, resv, argc, argv);
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'gp_fun'");
}
#endif
#ifdef __cplusplus
} /* extern "C" */
