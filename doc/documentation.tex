...
\begin{enumerate}
    \item check \textit{Python} compatibility version with your MATLAB version and install \textit{Python} from \texttt{https://www.python.org/downloads/} using Windows installer. Set the check for adding python to PATH.%at\\ \texttt{https://www.mathworks.com/content/dam/mathworks/mathworks-dot-com/support/sysreq/files/python-compatibility.pdf}
