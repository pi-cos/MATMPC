...
npODE=4; % No. of model parameters
...
% GP
T = 200; % No. of training points for the GP
...
psi_bar = [psi_hat_1*Ts_st/2; ... ...
          psi_hat_2*Ts_st/2; ... ...
          psi_hat_1;...
          psi_hat_2...
         ];
     
% define the GP jacobians wrt states and inputs
gp_grad = jacobian(psi_bar,x_star) + SX.zeros(nx,nx+nu);
